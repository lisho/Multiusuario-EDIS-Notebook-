...
export const QuickMobileHubModal: React.FC<QuickMobileHubModalProps> = ({
    ...
    const handleSaveDictatedIntervention = async () => {
        ...
        const newIntervention: Omit<Intervention, 'id'> = {
            ...
            status: InterventionStatus.Completed, // Saved as completed since it was just performed/dictated
        ...
        try {
            ...
            console.error('Error saving dictated intervention:', err);
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-slate-50 border-2 border-slate-200 rounded-2xl p-3.5 space-y-3">
                                    ...
                                    >
                                        {isListening ? (
                                            ...
                                            <>
                                                ...
                                                <span>{dictatedNotes ? 'Continuar dictando por voz' : 'Iniciar dictado por voz'}</span>
                                            </>
                                        )}
                                    </button>
                                ...
                                <textarea
                                    ...
                                    rows={5}
                                    placeholder="Aquí aparecerá lo que dictes por voz, o puedes escribir libremente los detalles de la actuación..."
                            ...
                            >
                                {saveSuccess ? (
                                    ...
                                    <>
                                        ...
                                        <span>{isSavingIntervention ? 'Guardando...' : 'Guardar Intervención Realizada'}</span>
                                    </>
                                )}
                            </button>
                        </div>
                                ...
                                <div className="bg-amber-50 border-2 border-amber-300 rounded-xl p-3 shadow-xs space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        {todayPendingAllDay.map(item => (
                                            <div key={item.id} className="bg-white border border-amber-200 rounded-lg p-2.5 flex items-center justify-between gap-2 shadow-2xs">
                                                ...
                                                <button
                                                    ...
                                                    className="px-2.5 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs flex items-center gap-1 flex-shrink-0 shadow-2xs cursor-pointer"
                                        ...
                                        return (
                                            <div 
                                                ...
                                                className={`p-3 rounded-xl border flex items-center justify-between gap-3 transition-colors ${
                                                    isDone ? 'bg-slate-50 border-slate-200 opacity-80' : 'bg-white border-slate-200 shadow-2xs'
                                                }`}
                                            >
                                                ...
                                                <button
                                                    ...
                                                    className={`px-2.5 py-1 rounded-md text-xs font-semibold flex items-center gap-1 flex-shrink-0 transition-colors cursor-pointer ${
                                                        isDone 
